...
function AboutPage() {
  return (
    <section id='about' className='font-sans w-full h-screen flex flex-col px-4 sm:px-6 lg:px-10 scroll-mt-14 pt-14'>
      <header className='max-w-2xl flex flex-col gap-2 mb-2'>
        <h1
        ...
        <p
          className='text-base md:text-lg text-pretty max-w-xl'
          style={{
            lineHeight: 1.6,
      ...
      <MagicBento fullWidth cards={clothlyValues} glowColor={WARM_AMBER_GLOW} />
    </section>
  )
}
