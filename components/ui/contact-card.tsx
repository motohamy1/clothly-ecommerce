...
export function ContactCard({
	...
	return (
		<div
			className={cn(
				'bg-mencolor border relative grid h-full w-full shadow md:grid-cols-2 lg:grid-cols-3',
				className,
			)}
			{...props}
		>
			...
			<div
				className={cn(
					'bg-mencolor flex h-full w-full items-center border-t p-5 md:col-span-1 md:border-t-0 md:border-l',
					formSectionClassName,
				)}
			>
				{children}
