...
const TEXTURE_FALLBACK_BG = 'oklch(0.82 0.05 75)';
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  const resolvedCards = cards?.length ? cards : cardData;
  const isFeaturedLayout = resolvedCards.length === 1;
      ...
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            .card-responsive:not(.card-responsive--featured) .card:nth-child(3) {
              grid-column: span 2;
              grid-row: span 2;
            }
            
            .card-responsive:not(.card-responsive--featured) .card:nth-child(4) {
              grid-column: 1 / span 2;
              grid-row: 2 / span 2;
            }
            
            .card-responsive:not(.card-responsive--featured) .card:nth-child(6) {
              grid-column: 4;
              grid-row: 3;
            }
          }

          .card-responsive--featured .card {
          ...
          @media (max-width: 599px) {
            ...
            .card-responsive:not(.card-responsive--featured) .card {
              width: 100%;
              min-height: 180px;
            }
          }
            ...
            const cardStyle = {
              ...
              ...(card.backgroundImage
                ? {
                    ...
                    backgroundColor: TEXTURE_FALLBACK_BG,
                  }
                : {
