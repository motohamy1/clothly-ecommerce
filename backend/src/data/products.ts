...
export const productSeeds: ProductSeed[] = [
  ...
  product({ id: 'kids-playground-runner', section: 'kids', group: 'shoes', category: 'shoe', name: 'Playground Runner', price: 39.99, imageIndex: 5, sizes: kidsSizes, description: 'Lightweight runners with hook-and-loop straps and cushioned soles for all-day play.' }),
  product({ id: 'kids-rain-boot', section: 'kids', group: 'shoes', category: 'shoe', name: 'Rain Boot', price: 34.99, imageIndex: 4, sizes: kidsSizes, description: 'Waterproof pull-on rain boots with easy handles and a flexible lug sole.' }),
];
