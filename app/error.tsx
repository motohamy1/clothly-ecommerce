  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#FAF7F2] px-4">
      <div className="max-w-[480px] text-center">
        <h1 className="text-[24px] font-semibold text-[#1A1814]">The shop is taking a moment.</h1>
        <p className="mt-3 text-[15px] text-[rgba(26,24,20,0.6)]">
          Try again in a minute. If it keeps happening, reach the team at hello@clothly.test.
        </p>
        <button
          onClick={reset}
