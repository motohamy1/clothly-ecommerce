import type { Product, ProductSection, ProductGroup, ProductVariant, ProductCollection } from './products';
...
function product(input: {
  ...
  return {
    ...rest,
    images: gallery(rest.image, imagePool),
    variants: rest.variants ?? coreVariants,
  };
}
...
export const productSeeds = allProducts;

export { type ProductSection, type ProductGroup, type ProductCollection, type ProductVariant };
export type { Product };
